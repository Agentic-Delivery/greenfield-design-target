...
| **Accent** | `--accent` | `oklch(0.71 0.135 62)` | **Calmer warm amber**, ~56% sat — the single brand accent, refined down from the original hi-vis orange (`0.70 0.18 50`) so it keeps glare legibility without shouting. Carries the ~10%. Not the AI blue/purple. |
